...
arma::imat ixyi_table_by_z(
    NumericVector event,
    NumericVector x_events, NumericVector y_events,
    NumericVector reset_labels, NumericVector break_labels,
    NumericVector bin_labels, int max_bins ){
